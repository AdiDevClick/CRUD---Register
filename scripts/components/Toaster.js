...
import { wait, createElement } from "../functions/dom.js";
...
export class Toaster {
    ...
    constructor(message, type = "Erreur") {
        ...
        this.#template = document.querySelector(
            this.toasterContainer.dataset.template
        );

        this.#alert = this.#template.content.firstElementChild.cloneNode(true);

        this.#progressBar = this.#alert.querySelector(
            this.toasterContainer.dataset.progressbar
        );
        this.#closeBtn = this.#alert.querySelector(
            this.toasterContainer.dataset.closebtn
        );
    ...
    async #removeAlert() {
        ...
        if (this.toasterContainer.childNodes.length <= 0)
