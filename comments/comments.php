...
<form data-target="<?= AJAXCONTROLLER ?>" class="comment-form" action="<?= strip_tags($rootUrl) . 'recettes/comments/post_create.php' ?>" method="POST">
    <!-- <form data-target="../recipes/Process_PreparationList.php" class="comment-form" action="<?= strip_tags($rootUrl) . 'recettes/comments/post_create.php' ?>" method="POST"> -->
