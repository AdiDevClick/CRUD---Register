        ...
        <nav class="navbar-grid">
            ...
            <div class="navbar">
                ...
                <!-- <div class="logo form-logo">
                    ...
                    <a href="<?php // echo strip_tags($rootUrl). $clicServer.'/index.php'
                                ?>"></a>
                </div> -->
                <!-- <div class="logo"><a href="<?php // echo strip_tags($rootUrl). $clicServer.'/index.php'
                                                ?>">AdiDevClick</a></div> -->
                <!-- end of default -->
                <!-- <div class="nav"> -->
                ...
                <form
                    ...
                    <div class="search" id="search">
                        <!-- <form id="search-form" class="search-form" action="<?php // $rootUrl. $clicServer.'/index.php'
